...
const AutoQuote        = lazyWithRetry(() => import('./pages/admin/autoquote/AutoQuote.tsx'))
...
const EvidenceQuickCapture = lazyWithRetry(() => import('./pages/evidence/EvidenceQuickCapture.jsx'))
